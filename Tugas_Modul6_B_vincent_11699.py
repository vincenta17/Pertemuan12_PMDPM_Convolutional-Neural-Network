...
model = load_model(r'D:\Semester 5\Pembelajaran Mesin Dan Mendalam\module 6\Tugas6_B_11699\model_mobilenet.h5')
...
# Streamlit UI
st.title("Prediksi Kematangan Buah Naga 1699")  # 4 digit npm terakhir
